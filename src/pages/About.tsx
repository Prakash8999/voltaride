...
const About = () => {
  const short = "Electro Vive builds smart, made-in-India electric scooters with IP67 motors and advanced lithium batteries — no license required for riders.";
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="mt-10 flex justify-center">
            <div className="glass rounded-2xl p-6 max-w-md w-full">
              ...
              <p className="text-sm text-muted-foreground mb-2 text-center">Sales@electrovive.in</p>
